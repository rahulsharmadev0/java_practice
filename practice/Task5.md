...
1. The first integer specifies the condition to check for (`1` for Odd/Even, `2` for Prime, or `3` for Palindrome).
2. The second integer denotes the number to be checked.
